...
// Next line added by me Nov 2013 to allow left scroll on A to go to Z and vice versa				
				
			that.currentPage = that.currentPage < 0 ? that.pageCount-1 : that.currentPage > that.pageCount-1 ? 0 : that.currentPage;				
